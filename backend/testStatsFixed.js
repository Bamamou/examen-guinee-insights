// Test script to verify fixed mention mapping
...
async function testStats() {
  try {
    ...
    sampleRegions.forEach(region => {
      ...
      console.log(`  Mentions - TBIEN: ${region.tbien_count}, BIEN: ${region.bien_count}, ABIEN: ${region.assez_bien_count}, Passable: ${region.passable_count}`);
      console.log('');
    });
